...
import com.mycompany.proyect.controlador.AsesorControlador;
...
/**
 * Portal del Asesor Pedagógico — diseño visual conservado íntegro.
 * Adaptaciones: recibe AsesorPedagogico autenticado, muestra nombre real,
 * instancia controladores y pasa datos reales a paneles internos.
 * esTutor=false → bitácora sin campos de nota/observación (solo lectura).
 */
public class PortalAsesorPedagogico extends JFrame {
    ...
    public PortalAsesorPedagogico(AsesorPedagogico asesor) {
        ...
        setTitle("SIGEP - Portal Asesor Pedagógico");
        ...
        // Práctica Académica — esTutor=false → bitácora solo lectura
        ...
        practicaContainer.add(new PanelPracticasTutor(practicaCardLayout, practicaContainer, false), "LISTA");
        practicaContainer.add(new PanelBitacoraTutor(practicaCardLayout, practicaContainer, false), "BITACORA");
        practicaCardLayout.show(practicaContainer, "LISTA");
        mainContentPanel.add(practicaContainer, "PracticaAcademica");

        // Perfil con datos reales del asesor
        mainContentPanel.add(new PanelPerfil(
            "Asesor Pedagógico",
            asesor.getNombre(), asesor.getApellido(),
            asesor.getTipoDocumento(), asesor.getNumDocumento(),
            asesor.getCorreoInst(), asesor.getEstado()
        ), "Perfil");
    ...
    public AsesorControlador   getAsesorCtrl()   { return asesorCtrl; }
    ...
    public AsesorPedagogico    getAsesorActual() { return asesorActual; }
