...
import com.mycompany.proyect.controlador.EstudianteControlador;
 ...
 * Adaptaciones añadidas:
 *   - Constructor recibe Estudiante autenticado
 *   - Muestra nombre real del estudiante en la barra superior
 *   - Instancia los controladores para CRUD y acceso a datos
 *   - PanelMiPractica recibe el numDocumento del estudiante para cargar su práctica real
 */
public class StudentDashboard extends JFrame {
    ...
    // Controladores — disponibles para los paneles internos
    ...
    public StudentDashboard(Estudiante estudiante) {
        ...
        lblLogout.addMouseListener(new MouseAdapter() {
            @Override public void mouseClicked(MouseEvent e) {
                dispose();
                LoginWindow loginPost = new LoginWindow();
                new com.mycompany.proyect.controlador.LoginControlador(loginPost);
                loginPost.setVisible(true);
            }
        });
        ...
        // Mi Práctica con sub-CardLayout (Tarjeta ↔ Bitácora)
        PanelMiPractica panelMiPractica = new PanelMiPractica(practicaCardLayout, practicaContainer);
        PanelBitacoraEstudiante panelBitacora = new PanelBitacoraEstudiante(practicaCardLayout, practicaContainer);
        ...
        // Perfil con datos reales del estudiante
        PanelPerfil panelPerfil = new PanelPerfil(
            "Estudiante",
            estudiante.getNombre(),
            estudiante.getApellido(),
            estudiante.getTipoDocumento(),
            estudiante.getNumDocumento(),
            estudiante.getCorreoInst(),
            estudiante.getEstado()
        );
        mainContentPanel.add(panelPerfil, "Perfil");
    ...
    // ── Getters de controladores para paneles internos ────────────────────────
